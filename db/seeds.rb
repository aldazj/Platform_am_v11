...
jayro = Person.create(id:1, lastname:'Aldaz', firstname:'Jayro', password:'jayro', password_confirmation:'jayro', email:'jayroaldaz@hotmail.com', dateofbirth:'1988-01-02', private_phone:'076 654 45 35', professional_phone:'022 234 45 35', type:admin, name:'Aldaz Jayro')
